 ...
 */
// plugin definition
//event hook handler sets values fornew elements 
    ...
    public function handleEvent($a_component, $a_event, $a_parameter) : void
    {
        ...
        if (
            ...
            if (
                ...
                if ($pluginSettings->isTimelineEnabledFor($object->getType())) {
                    $object->setNewsTimeline(true);
                }
                if ($pluginSettings->isTimelineAutoEntryEnabledFor($object->getType())) {
